<template>
    <div class="league">
        ...
        <div class="league-matchs">
            <template v-if="leagueStorage[name].value.length > 0 && leagueStorage[name].value[0]?.content">
                <app-table
                    v-for="(match, idx) in leagueStorage[name].value[0].content"
                    :key="'match' + idx"
                    :name="name"
                    ...
                    :match="leagueStorage[name].value"
